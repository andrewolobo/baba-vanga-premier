...
- Gate ledger: `trials.count_configurations(conn)` — **112 / 69 / 202** at last
  ...
  is behind.
- Tests: `pytest -q` — **794 pass** at last run (2026-09-21, SEO 2.5/2.6,
