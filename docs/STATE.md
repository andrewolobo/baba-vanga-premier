...
file is stale — fix this file. Updated **2026-09-24**.
...
- Gate ledger: `trials.count_configurations(conn)` — **112 / 69 / 202** at last
  ...
  is behind.
- Tests: `pytest -q` — **795 pass** at last run (2026-09-21, SEO 2.8,
  Python 3.11, on the owner's Postgres), plus **89** in `cd web && npm test`; the prose has been stale
  before.
