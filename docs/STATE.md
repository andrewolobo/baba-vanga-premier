...
| item | state | next |
| --- | --- | --- |
| **SEO** (`SEO_PLAN.md`) | **1.1–1.6 live** (checked 2026-09-17, `123307f`); certbot renewal hook confirmed by the owner; PageSpeed mobile baseline **48 / LCP 5.7 s / TBT 130 ms / CLS 0.337**; **1.7 share image + 1.8 page weight built, uncommitted**; CLS traced to the header's sign-in slot wrapping at phone width (0.267 of it, `SEO_PLAN.md` 1.10) | deploy 1.7/1.8 (`deploy.sh`); **1.10** reserve the sign-in slot (header design, owner sees it first); Search Console data when it arrives; pages lack nosniff/referrer headers (F8, not SEO); D1 decides Phase 2 (and LCP) |
